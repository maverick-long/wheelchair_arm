/*=========================================================================
  ...
  Module:    vtkQuadricDecimation2.cxx
...
#include "vtkQuadricDecimation2.h"
...
vtkStandardNewMacro(vtkQuadricDecimation2);


//----------------------------------------------------------------------------
vtkQuadricDecimation2::vtkQuadricDecimation2()
{
...
void vtkQuadricDecimation2::SetPointAttributeArray(vtkIdType ptId, 
                                                  const double *x) 
{
  int i;
...
void vtkQuadricDecimation2::GetPointAttributeArray(vtkIdType ptId, double *x) 
{
  int i;
...
//----------------------------------------------------------------------------
int vtkQuadricDecimation2::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  this->ErrorQuadrics = 
    new vtkQuadricDecimation2::ErrorQuadric[numPts];
...
//----------------------------------------------------------------------------
void vtkQuadricDecimation2::InitializeQuadrics(vtkIdType numPts)
{
...
void vtkQuadricDecimation2::AddBoundaryConstraints(void) 
{
  vtkPolyData *input = this->Mesh;
  double *QEM;
  vtkIdType  cellId;
...
//----------------------------------------------------------------------------
void vtkQuadricDecimation2::AddQuadric(vtkIdType oldPtId, vtkIdType newPtId)
{
  int i;
...
//----------------------------------------------------------------------------
void vtkQuadricDecimation2::FindAffectedEdges(vtkIdType p1Id, vtkIdType p2Id,
                                              vtkIdList *edges)
{
...
void vtkQuadricDecimation2::UpdateEdgeData(vtkIdType pt0Id, vtkIdType pt1Id)
{
...
//----------------------------------------------------------------------------
double vtkQuadricDecimation2::ComputeCost(vtkIdType edgeId, double *x)
{
...
//----------------------------------------------------------------------------
double vtkQuadricDecimation2::ComputeCost2(vtkIdType edgeId, double *x)
{
...
int vtkQuadricDecimation2::TrianglePlaneCheck(const double t0[3], 
                                             const double t1[3], 
                                             const double t2[3],  
                                             const double *x) {
...
int vtkQuadricDecimation2::IsGoodPlacement(vtkIdType pt0Id, vtkIdType pt1Id, 
const double *x) 
{
...
void vtkQuadricDecimation2::ComputeNumberOfComponents(void) 
{
...
//----------------------------------------------------------------------------
void vtkQuadricDecimation2::PrintSelf(ostream& os, vtkIndent indent)
{
